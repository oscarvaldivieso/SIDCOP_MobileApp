...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    if (_passwordController.text.isEmpty) {
      setState(() {
        _passwordError = 'Este campo es requerido';
      });
      hasError = true;
    }
    ...
    try {
      ...
      if (result != null && result['error'] != true) {
        ...
        // Login fallido - mostrar error general
        setState(() {
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => const ForgotPasswordScreen(), // Añadido const
                                  ),
                                );
                              },
                              child: const Text( // Añadido const
                                '¿Olvidaste tu contraseña?',
                                style: TextStyle(
                                  color: Color(0xFF98774A),
                                  fontFamily: 'Satoshi',
