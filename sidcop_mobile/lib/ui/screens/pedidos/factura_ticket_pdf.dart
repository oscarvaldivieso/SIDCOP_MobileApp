      ...
      build: (context) {
        return pw.Column(
          ...
          children: [
            ...
            pw.Text('C.A.I: 31FB47-AFB25B-872CE0-63BE03-090949-03', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 9)),
            pw.Text('No. Factura: $numeroFactura', style: pw.TextStyle(fontSize: 9)),
            ...
            pw.Text('Tipo Factura: Pedido', style: pw.TextStyle(fontSize: 9)),
            pw.Divider(),
