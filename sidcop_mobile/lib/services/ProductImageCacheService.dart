...
class ProductImageCacheService {
  ...
  // Note: CacheService and EncryptedCsvStorageService methods are static
  ...
  Future<void> _saveImageMapping() async {
    try {
      ...
      await EncryptedCsvStorageService.saveData('product_images_mapping', csvData);
  ...
  Future<void> clearImageCache() async {
    try {
      ...
      // Limpiar CSV cifrado
      await EncryptedCsvStorageService.clearData('product_images_mapping');
