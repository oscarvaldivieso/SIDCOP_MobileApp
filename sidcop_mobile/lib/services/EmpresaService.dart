...
class EmpresaService {
  ...
  Future<List<ConfiguracionFacturaViewModel>> getConfiguracionFactura() async {
    ...
    try {
      ...
      developer.log(
        'Get ConfiguracionFactura Response Status: ${response.statusCode}',
      );
      ...
      if (response.statusCode == 200) {
        ...
        var config = configuracionFacturaList
            .map(
              (json) => ConfiguracionFacturaViewModel.fromJson(
