...
class VerificarService {
  ...
  static Future<void> verificarCredencialesOffline() async {
    try {
      ...
      developer.log(
        'Saved Email: ${savedEmail.isNotEmpty ? savedEmail : "VACÍO"}',
      );
      developer.log(
        'Saved Password: ${savedPassword.isNotEmpty ? "EXISTE" : "VACÍO"}',
      );
      ...
      developer.log(
        'Offline Credentials: ${credentialsJson != null ? "EXISTE" : "NO EXISTE"}',
      );
      developer.log(
        'Offline User Data: ${userDataJson != null ? "EXISTE" : "NO EXISTE"}',
      );
  ...
  static Future<bool> verificarConexion() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        developer.log(
          'Conexión verificada: OFFLINE (Status: ${response.statusCode})',
        );
      }
    } catch (e) {
